...
class Customer:
    ...
    def create_order(self, coffee, price):
        # order matters without keyword arguments
    ...
    def most_aficionado(cls, coffee):
        # return max(cls.all, key=lambda customer: customer.total_for_sepcific_coffee(coffee), default=None)
    ...
    ### 'key=lambda customer:' => How to use 'lambda' ###
